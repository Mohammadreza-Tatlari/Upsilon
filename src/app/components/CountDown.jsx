...
export default function CountDown() {
  ...
  return (
    <>
        <div className="p-4 bg-gradient-to-br from-gray-950 to-slate-700">
          <div className="w-full max-w-5xl mx-auto flex items-center bg-white hover:text-white hover:bg-slate-900 transition-all duration-500">
